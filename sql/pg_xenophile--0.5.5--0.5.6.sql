...
-- In the actual release of 0.5.6, there was an accidental redefinition of the `test__l10n_table()`
-- procedure here, but without the changes!  So I wasn't actually testing the extra assertions.
