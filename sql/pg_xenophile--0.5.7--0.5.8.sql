...
-- Add column to `test_species` table to trigger duplicate PK on INSERT bug.
...
-- Fix boolean logic bug that causes the PK column to be included in the INSERT twice sometimes.
